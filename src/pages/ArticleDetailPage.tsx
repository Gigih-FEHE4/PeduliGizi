    ...
    const dummyArticles = [
        {
            ...
            content:`Sebagian besar masyarakat mungkin belum memahami istilah yang disebut stunting. Stunting adalah masalah kurang gizi kronis yang disebabkan oleh kurangnya asupan gizi dalam waktu yang cukup lama, sehingga mengakibatkan gangguan pertumbuhan pada anak yakni tinggi badan anak lebih rendah atau pendek (kerdil) dari standar usianya.
            Kondisi tubuh anak yang pendek seringkali dikatakan sebagai faktor keturunan (genetik) dari kedua orang tuanya, sehingga masyarakat banyak yang hanya menerima tanpa berbuat apa-apa untuk mencegahnya. Padahal seperti kita ketahui, genetika merupakan faktor determinan kesehatan yang paling kecil pengaruhnya bila dibandingkan dengan faktor perilaku, lingkungan (sosial, ekonomi, budaya, politik), dan pelayanan kesehatan. Dengan kata lain, stunting merupakan masalah yang sebenarnya bisa dicegah
            Salah satu fokus pemerintah saat ini adalah pencegahan stunting. Upaya ini bertujuanagar anak-anak Indonesia dapat tumbuh dan berkembang secara optimal dan maksimal, dengan disertai kemampuan emosional, sosial, dan fisik yang siap untuk belajar, serta mampu berinovasi dan berkompetisi di tingkat global.
        ...
        },
        {
            ...
            Anak-anak terserang infeksi sejak di dalam kandungan atau ketika baru lahir sehingga pertumbuhan tinggi badannya terhambat.
            Perubahan hormon pada ibu hamil atau bayi yang berimbas pada laju pertumbuhan.
            Ikatan emosional antara orang tua dan anak kurang kuat. Ini kerap menjadikan orang tua cenderung kurang peduli terhadap kebutuhan gizi anak sejak masih dalam kandungan maupun setelah lahir. Penyebab ini biasanya terjadi pada korban perundungan seksual atau kehamilan yang tidak direncanakan.
            ...
            2.    Meskipun proporsi tubuh tampak normal (tidak terlalu gemuk atau tidak terlalu kurus), penampilan anak terlihat lebih muda daripada usia sebenarnya.
            3.    Pertumbuhan gigi tergolong lambat.
            4.    Persebaran lemak pada tubuh tidak merata sehingga ada bagian tubuh yang tampak lebih berlemak, misalnya pipi chubby.
        ...
        },
        {
            ...
            Hindari mengonsumsi minuman beralkohol, kafein, minuman bersoda, ikan dengan kandungan merkuri tinggi.
